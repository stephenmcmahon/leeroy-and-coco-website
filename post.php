...
<title>Leeroy &amp; Coco - Thank you</title>
...
<section class="banner-about">
	<div class="container">
		<div class="row">
			<div class="col-sm-11">
				<p>Thank you for subscribing! Get ready to be a part of something special.</p>
				<br />
				<?php
				$email = "info@leeroyandcoco.com";

				print "<p>The following information was submitted from the form:<p>
				...
				mail( $email, "Newsletter signup from www.leeroyandcoco.com", $message, "From: $email Form Submission (Highest)" );
				?>
			</div>
		</div>
	</div>
